                ...
                <div className="list-group list-group-flush">
                  ...
                  <a href="#" className="list-group-item list-group-item-action border-bottom">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <img alt="Image placeholder" src="assets/img/profile-picture-1.jpg" className="avatar-md rounded" />
                      </div>
                  ...
                  <a href="#" className="list-group-item list-group-item-action border-bottom">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <img alt="Image placeholder" src="assets/img/profile-picture-2.jpg" className="avatar-md rounded" />
                      </div>
                      <div className="col ps-0 ms-2">
                        <div className="d-flex justify-content-between align-items-center">
                          <div>
                  ...
                  <a href="#" className="list-group-item list-group-item-action border-bottom">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <img alt="Image placeholder" src="assets/img/profile-picture-3.jpg" className="avatar-md rounded" />
                      </div>
                  ...
                  <a href="#" className="list-group-item list-group-item-action border-bottom">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <img alt="Image placeholder" src="assets/img/profile-picture-4.jpg" className="avatar-md rounded" />
                      </div>
                      <div className="col ps-0 ms-2">
                        <div className="d-flex justify-content-between align-items-center">
                          <div>
                  ...
                  <a href="#" className="list-group-item list-group-item-action border-bottom">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <img alt="Image placeholder" src="assets/img/profile-picture-5.jpg" className="avatar-md rounded" />
                      </div>
                      <div className="col ps-0 ms-2">
                        <div className="d-flex justify-content-between align-items-center">
                          <div>
            ...
            <li className="nav-item dropdown ms-lg-3">
              <a className="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <div className="media d-flex align-items-center">
                  <img className="avatar rounded-circle" alt="Image placeholder" src="assets/img/profile-picture-3.jpg" />
                ...
                <ul className="list-group list-group-flush list my--3">
                  <li className="list-group-item px-0">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <a href="#" className="avatar"><img className="rounded" alt="Image placeholder" src="assets/img/profile-picture-1.jpg" /></a>
                      </div>
                  ...
                  <li className="list-group-item px-0">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <a href="#" className="avatar"><img className="rounded-circle" alt="Image placeholder" src="assets/img/profile-picture-2.jpg" /></a>
                      </div>
                      <div className="col-auto ms--2">
                        <h4 className="h6 mb-0"><a href="#">Jose Leos</a></h4>
                        <div className="d-flex align-items-center">
                          <div className="bg-warning dot rounded-circle me-1" />
                  ...
                  <li className="list-group-item px-0">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <a href="#" className="avatar"><img className="rounded-circle" alt="Image placeholder" src="assets/img/profile-picture-3.jpg" /></a>
                      </div>
                      <div className="col-auto ms--2">
                        <h4 className="h6 mb-0"><a href="#">Bonnie Green</a></h4>
                        <div className="d-flex align-items-center">
                          <div className="bg-danger dot rounded-circle me-1" />
                          <small>Offline</small>
                        </div>
                      </div>
                      <div className="col text-end">
                  ...
                  <li className="list-group-item px-0">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        {' '}
                        <a href="#" className="avatar"><img className="rounded-circle" alt="Image placeholder" src="assets/img/profile-picture-4.jpg" /></a>
                      </div>
                      <div className="col-auto ms--2">
              ...
              <div className="card-body">
                  ...
                  <div className="col">
                    <div className="progress-wrapper">
                      ...
                      <div className="progress mb-0">
                        <div className="progress-bar bg-success" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style={{ width: '75%' }} />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="row align-items-center mb-4">
                  ...
                  <div className="col">
                    <div className="progress-wrapper">
                      <div className="progress-info">
                        <div className="h6 mb-0">therichpost - Design System</div>
                ...
                <div className="row align-items-center mb-4">
                  ...
                  <div className="col">
                    <div className="progress-wrapper">
                      ...
                      <div className="progress mb-0">
                        <div className="progress-bar bg-warning" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style={{ width: '45%' }} />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="row align-items-center mb-3">
                  ...
                  <div className="col">
                    <div className="progress-wrapper">
                      <div className="progress-info">
                        <div className="h6 mb-0">Backend for therichpost v2</div>
                        <div className="small fw-bold text-gray-500"><span>34 %</span></div>
                      </div>
                      <div className="progress mb-0">
                        <div className="progress-bar bg-danger" role="progressbar" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100" style={{ width: '34%' }} />
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="col-12 col-xl-4">
        <div className="col-12 px-0 mb-4">
          <div className="card border-0 shadow">
            <div className="card-header d-flex flex-row align-items-center flex-0 border-bottom">
              ...
              <div className="d-block ms-auto">
                <div className="d-flex align-items-center text-end mb-2">
                  <span className="dot rounded-circle bg-gray-800 me-2" />
                  {' '}
                  <span className="fw-normal small">July</span>
                </div>
                <div className="d-flex align-items-center text-end">
                  <span className="dot rounded-circle bg-secondary me-2" />
                  {' '}
            ...
            <div className="card-body p-2">
              <div className="ct-chart-ranking ct-golden-section ct-series-a" />
            </div>
          </div>
        </div>
        <div className="col-12 px-0 mb-4">
